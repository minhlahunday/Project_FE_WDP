          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-light text-gray-900 tracking-tight">
                Chọn hai mẫu xe VinFast
              </h1>
              <p className="text-gray-600 mt-2 text-lg">{mockVehicles.length} mẫu xe có sẵn</p>
            </div>
            <button 
              onClick={() => navigate(-1)}
              className="text-gray-600 hover:text-gray-900 p-2 rounded-full hover:bg-gray-100 transition-all duration-200"
            >
              <X className="h-8 w-8" />
            </button>
          </div>
